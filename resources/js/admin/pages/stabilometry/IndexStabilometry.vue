<template>
    <Section class="main-container pb-5">
        <Header title="Estabilometría" image="/img/admin/sidebar/stabilometryWhite.svg"></Header>
...
import FormStabilometry from "../../components/stabilometry/FormStabilometry";
import DetailsStabilometry from "../../components/stabilometry/DetailsStabilometry";
import Header from "../../components/header/Header";
import {bus} from "../../app";
export default {
    name: "IndexStabilometry",
    components: {CreateTable, FormStabilometry, Header,DetailsStabilometry },
    mixins: [MixinTable],
    created() {
        this.URL_INDEX_CONTENT=route('admin_stabilometry_index_content');
        this.URL_UPDATE_STATUS = route('admin_stabilometry_active',{investigationId: 'FAKE_ID'});
