...
export default {
    ...
    created() {
        this.URL_CREATE_INVESTIGATION = route('admin_accelometer_create');
        this.URL_UPDATE_INVESTIGATION = route('admin_accelometer_update', {investigationId: 'FAKE_ID'});
