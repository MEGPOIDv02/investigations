...
export default {
    ...
    created() {
        this.URL_CREATE_INVESTIGATION = route('admin_stabilometry_create');
        this.URL_UPDATE_INVESTIGATION = route('admin_stabilometry_update', {investigationId: 'FAKE_ID'});
